...
const Hero = () => {
  ...
  return (
    ...
    <section className="bg-[#0c4244] text-white pt-36 pb-10 md:pt-40 md:pb-20">
      <motion.section
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 0.5 }}
      >
        <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 gap-12 items-center">
          <motion.div
          ...
          >
            <div className="m-1 md:m-10">
              <h1 className="text-3xl lg:text-5xl font-bold mb-6">Secure Your Financial Future with Infinium Finance Solutions</h1>
              <p className="mb-6 text-lg sm:text-xl text-teal-50">Experience our powerful compounding investment model that provides consistent quarterly returns of 6%, allowing your money to grow substantially over time.</p>
              <div className="flex flex-wrap gap-4">
                <button className="bg-yellow-600 hover:bg-yellow-700 text-white px-6 sm:px-9 py-3 rounded-md font-medium shadow-lg hover:shadow-xl transform hover:scale-105 transition duration-300 ease-in-out">Invest Now</button>
                <button className="h-12 bg-white text-black border-2 border-white hover:bg-white/10 hover:text-white transition-all duration-300 px-6 sm:px-10 py-2 rounded-md font-medium">Learn More</button>
              </div>
            </div>
          </motion.div>
                ...
                <div className="ml-auto">
                  <div className="flex items-center justify-center h-20">
                    <div className="relative w-[70px] h-[70px] overflow-hidden group">
                      <div className={`absolute top-0 right-1/2 h-full bg-[#c99d2ed5] origin-right ${animate ? 'animate-centerin' : 'animate-centerout'}`} />
                      {showRupee && (
                      ...
                      <div className={`absolute top-0 left-1/2 h-full bg-[#c99d2ed5] origin-left ${animate ? 'animate-centerin' : 'animate-centerout'}`} />
                    </div>
                  </div>
                </div>
              </div>
